              ...
              <div class="submission-box">
                <div class="instruction-report d-flex">
                  <div class="bt-box">
                    ...
                    <ModalBoir
                      v-if="isModalVisible && modalType === 'instruction'"
                      @click="closeModal"
                    />
                  </div>
          ...
          <div class="filling-form-que">
            <ol>
              <li>
                <label
                  ><span class="red">*</span
                  ><strong>Type of filing:</strong></label
                >
                <div style="margin-left: 15px; margin-top: 8px">
                  <ol class="filing-list-inner" type="a">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-8">
                          <input
                            type="radio"
                            class="radio-start"
                            v-model="formData.Initial_report"
                            name="reportType"
                            :value="true"
                          />
                        </div>
                    ...
                    <span
                      ...
                      ><em
                        >Reporting Company information associated with most
                        recent report, if any:</em
                      ></span
                    >
                    <li>
                      <div class="row">
                    ...
                    <li>
                      <div class="row">
                        ...
                        <div class="col-md-8">
                          ...
                          <span
                            v-if="formErrors.Tax_Identification_type"
                            class="error"
                    ...
                    <li>
                      <div class="row">
                        ...
                        <div class="col-md-8">
                          ...
                          />
                          <span
                            v-if="formErrors.Tax_Identification_number"
                            class="error"
                    ...
                    <li>
                      <div class="row">
                        ...
                        <div class="col-md-8">
                          <select
                            class="form-select"
                            v-model="formData.Jurisdiction_tax_id"
                            id="Jurisdiction_tax_id"
                          >
                            <option disabled>Choose...</option>
                            <option
                              v-for="option in jurisdictionCountry"
                              :key="option.value"
                              :value="option.value"
                            >
                              {{ option.label }}
                          ...
                          <span
                            v-if="formErrors.Jurisdiction_tax_id"
                            class="error"
                  ...
                  <div class="col-md-4">
                    <label
                      ><strong
                        >Date prepared
                        <span
                          >(auto-filled when form is finalized).</span
                        ></strong
                      ></label
                    >
                  </div>
              ...
              <li>
                <div class="row">
                  <div class="col-xl-4 col-md-4 col-sm-4">
                    <label
                      >Request to receive FinCEN Identifier (FinCEN ID)</label
                    >
                  </div>
                  <div class="col-xl-7 col-md-6 col-sm-8 select-rdo">
                    <input
                      type="checkbox"
                      name="fincen"
                      v-model="formData.FinCEN_Identifier"
                      value="true"
                    />
                ...
                <div class="row">
                  ...
                  <div class="col-xl-7 col-md-6 col-sm-8 select-rdo">
                    <input
                      type="checkbox"
                      name="foreign"
                      v-model="formData.Foreign_Pooled"
                      value="true"
                    />
                ...
                <div class="row">
                  ...
                  <div class="col-xl-7 col-md-6 col-sm-8">
                    <input
                      class="form-input"
                      type="text"
                      v-model="formData.Reporting_Company"
              ...
              <li>
                <div class="row" v-for="(alter, n) in alters" :key="n">
                  <div class="col-xl-4 col-md-4 col-sm-4">
                    <label
                      >Alternate name (e.g. trade name, DBA) #{{ n + 1 }}</label
                    >
                  </div>
                  <div class="col-xl-7 col-md-6 col-sm-8">
                    <input
                  ...
                  <li>
                    <div class="row">
                      ...
                      <div class="col-md-7">
                        <select
                          class="form-select"
                          v-model="formData.State_of_formation"
                        ...
                        <span
                          v-if="formErrors.State_of_formation"
                          class="error"
                  ...
                  <li>
                    <div class="row">
                      ...
                      <div class="col-md-7">
                        <select
                          class="form-select"
                          v-model="formData.Tribal_jurisdiction"
                        ...
                        <span
                          v-if="formErrors.Tribal_jurisdiction"
                          class="error"
                  ...
                  <li>
                    <div class="row">
                      ...
                      <div class="col-md-7">
                        <select
                          class="form-select"
                          v-model="formData.Tribal_first_jurisdiction"
                        ...
                        <span
                          v-if="formErrors.Tribal_first_jurisdiction"
                          class="error"
                  ...
                  <li>
                    <div class="row">
                      ...
                      <div class="col-md-7">
                        ...
                        />
                        <span
                          v-if="formErrors.Name_other_Tribe"
                          class="error"
              ...
              <li>
                <div class="row">
                  <div class="col-md-4">
                    <label
                      >Address (number, street, and apt. or suite no.)</label
                    >
                  </div>
                  <div class="col-md-7">
                    <input
                ...
                <div class="row">
                  ...
                  <div class="col-md-7 select-rdo">
                    <input
                      type="checkbox"
                      name="exit_report"
                      v-model="formData.Exit_reporting_company"
                      value="true"
                    />

                    <span class="sml mx-2"
                      >(check if Reporting Company was created or registered
              ...
              <div class="container" v-for="(input, a) in applicant" :key="a">
                <div class="applicant-wrapper section" id="applicant">
                  ...
                  <div class="add-p1">
                    ...
                    <button
                      v-else
                      @click.prevent="removeApplicant(a)"
                      class="remove-btn"
                    >
                      -
                    </button>
                ...
                <li>
                  <div class="row">
                    <div class="col-md-4">
                      <label
                        ><span class="red">*</span>Individual's last name</label
                      >
                    </div>
                    <div class="col-md-7">
                      <input
                      ...
                      />
                      <span
                        v-if="formErrors.Individual_last_name"
                        class="error"
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-7 d-flex">
                      <div class="current-radio-btn">
                        ...
                        <input
                          class="radio-start mx-2"
                          type="radio"
                          name="business"
                          :value="true"
                          v-model="formData.Business_beneficial"
                        />
                      </div>
                      <div class="current-radio-btn">
                        ...
                        <input
                          ...
                          name="business"
                          :value="true"
                          v-model="formData.Residential_applicant"
                        />
                      </div>
                    </div>
                  </div>
                ...
                <li>
                  <div class="row">
                    <div class="col-md-4">
                      <label
                        ><span class="red">*</span>Address (number, street,and
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-7">
                      <input
                        class="form-input"
                        type="text"
                        v-model="formData.City_applicant"
                        placeholder="City"
                      />
                ...
                <li>
                  <div class="row">
                    <div class="col-md-4">
                      <label
                        ><span class="red">*</span>Country/Jurisdiction</label
                      >
                    </div>
                    <div class="col-md-7">
                      <select
                ...
                <li>
                  <div class="row">
                    ...
                    <div class="col-md-7">
                      <select
                        class="form-select"
                        v-model="formData.State_applicant"
                        id="State_applicant"
                      >
                        <option disabled>Choose...</option>
                        <option
                ...
                <li>
                  <div class="row">
                    <div class="col-md-4">
                      <label
                        ><span class="red">*</span>ZIP/Foreign postal
                        code</label
                      >
                    </div>
                    <div class="col-md-7">
                      <input
                        class="form-input"
                        type="text"
                        v-model="formData.Foreign_postal"
                ...
                <li>
                  <div class="row">
                    <div class="col-md-4">
                      <label
                        ><span class="red">*</span>Identifying document
                        type</label
                      >
                    </div>
                    <div class="col-md-7">
                      <select
                        class="form-select"
                        v-model="formData.Identififying_document"
                        id="Identififying_document"
                      >
                        <option disabled>Choose...</option>
                        <option
                          v-for="option in document"
                          :key="option.value"
                          :value="option.value"
                        >
                          {{ option.label }}
                      ...
                      <span
                        v-if="formErrors.Identififying_document"
                        class="error"
                ...
                <li>
                  <div class="row">
                    ...
                    <div class="col-md-7">
                      ...
                      />
                      <span
                        v-if="formErrors.Identififying_number"
                        class="error"
                ...
                <li>
                  <label
                    ><span class="red">*</span>Identifying document issuing
                    jurisdiction:</label
                  >
                  <ol
                    type="a"
                    ...
                    <li>
                      <div class="row">
                        ...
                        <div class="col-md-7">
                          <select
                            class="form-select"
                            v-model="formData.Country_jurisdiction"
                            id="Country"
                          >
                            <option disabled>Choose...</option>
                            <option
                          ...
                          <span
                            v-if="formErrors.Country_jurisdiction"
                            class="error"
                ...
                <li>
                  <div class="row">
                    ...
                    <div class="col-md-7">
                      ...
                      <button
                        type="button"
                        class="file btn btn-primary mx-1"
                        @click="removeAttachmentapplicant"
                      >
                        Remove Attachment
                      </button>
                      <input
                        class="f-input form-input"
                        v-model="attachedFileNameApplicant"
                        readonly
                      />
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <label style="white-space: nowrap"
                        >(This item is reserved for future use)</label
                      >
                    </div>
                  </div>
                </li>
              ...
              <div class="container" v-for="(input, b) in beneficial" :key="b">
                <div class="applicant-wrapper section" id="beneficial">
                  ...
                  <div class="add-p1">
                    ...
                    <button
                      v-else
                      @click.prevent="removeBeneficial(b)"
                      class="remove-btn"
                    >
                      -
                    </button>
                ...
                <li>
                  <div class="row">
                    <div class="col-md-4">
                      <label
                        >Parent/Guardian information instead of minor
                        child</label
                      >
                    </div>
                    <div class="col-md-7 select-rdo">
                ...
                <li>
                  <div class="row">
                    ...
                    <div class="col-md-7">
                      <input
                        class="form-input"
                        v-model="formData.Beneficial_fincenID"
                        type="text"
                        placeholder="FinCEN ID"
                      />
                      <span
                        v-if="formErrors.Beneficial_fincenID"
                        class="error"
                ...
                <li>
                  <div class="row">
                    <div class="col-md-4">
                      <label
                        ><span class="red">*</span>Individual's last name or
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-7">
                      <input
                        class="form-input"
                        type="text"
                        v-model="formData.Beneficial_first_name"
                        placeholder="First name"
                      />
                      <span
                        v-if="formErrors.Beneficial_first_name"
                        class="error"
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-7">
                      <input
                        class="form-input"
                        type="text"
                        v-model="formData.Beneficial_Middle_name"
                        placeholder="Middle name"
                      />
                      <span
                        v-if="formErrors.Beneficial_Middle_name"
                        class="error"
                ...
                <li>
                  <div class="row">
                    ...
                    <div class="col-md-7">
                      <input
                        class="form-input"
                        v-model="formData.Beneficial_suffix"
                        type="text"
                        placeholder="Suffix"
                      />
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-7">
                      <input
                        class="form-input"
                        type="date"
                        v-model="formData.Beneficial_date"
                      />
                ...
                <li>
                  <div class="row">
                    ...
                    <div class="col-md-7">
                      <input
                        class="form-input"
                        v-model="formData.Beneficial_Address"
                        placeholder="Address (number, street, and apt. or suite no.)"
                        type="text"
                      />
                      <span
                        v-if="formErrors.Beneficial_Address"
                        class="error"
                ...
                <li>
                  <div class="row">
                    ...
                    <div class="col-md-7">
                      <input
                        class="form-input"
                        v-model="formData.Beneficial_city"
                        type="text"
                        placeholder="City"
                      />
                ...
                <li>
                  <div class="row">
                    ...
                    <div class="col-md-7">
                      <select
                        class="form-select"
                        v-model="formData.Beneficial_country_resi"
                      ...
                      <span
                        v-if="formErrors.Beneficial_country_resi"
                        class="error"
                ...
                <li>
                  <div class="row">
                    ...
                    <div class="col-md-7">
                      <select
                        class="form-select"
                        v-model="formData.Beneficial_state_resi"
                      ...
                      <span
                        v-if="formErrors.Beneficial_state_resi"
                        class="error"
                ...
                <li>
                  <div class="row">
                    ...
                    <div class="col-md-7">
                      <input
                        class="form-input"
                        v-model="formData.Beneficial_zipcode"
                        type="text"
                        placeholder="ZIP/Foreign postal code"
                      />
                      <span
                        v-if="formErrors.Beneficial_zipcode"
                        class="error"
                ...
                <li>
                  <div class="row">
                    ...
                    <div class="col-md-7">
                      <select
                        class="form-select"
                        v-model="formData.Beneficial_document_type"
                      ...
                      <span
                        v-if="formErrors.Beneficial_document_type"
                        class="error"
                ...
                <li>
                  <div class="row">
                    ...
                    <div class="col-md-7">
                      ...
                      />
                      <span
                        v-if="formErrors.Beneficial_document_number"
                        class="error"
                    ...
                    <li>
                      <div class="row">
                        ...
                        <div class="col-md-7">
                          <select
                            class="form-select"
                            v-model="formData.Beneficial_country"
                          ...
                          <span
                            v-if="formErrors.Beneficial_country"
                            class="error"
                    ...
                    <li>
                      <div class="row">
                        ...
                        <div class="col-md-7">
                          <select
                            class="form-select"
                            v-model="formData.Beneficial_state"
                          ...
                          <span
                            v-if="formErrors.Beneficial_state"
                            class="error"
                    ...
                    <li>
                      <div class="row">
                        ...
                        <div class="col-md-7">
                          <select
                            class="form-select"
                            v-model="formData.Beneficial_Local"
                            id="formData.Beneficial_Local"
                          >
                            <option disabled>Choose...</option>
                            <option
                          ...
                          <span
                            v-if="formErrors.Beneficial_Local"
                            class="error"
                    ...
                    <li>
                      <div class="row">
                        ...
                        <div class="col-md-7">
                          ...
                          />
                          <span
                            v-if="formErrors.Beneficial_Other_local"
                            class="error"
          ...
          <root>
			<BoirFormList>
				...
				<BeneficialOwner>
						...
						<EntityBeneficial>${this.formData.entity_beneficial}</EntityBeneficial>
