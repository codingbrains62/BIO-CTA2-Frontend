		...
		<div class="submission-wrapper section">			
			<div class="accordion accordion-flush" id="accordionFlushExample">
				<div class="accordion-item">
					...
					<h4 class="mb-0"><i class="fa-solid fa-bullhorn"></i> Report Preparation & Submission Instructions</h4>
					</button>
					</h2>
			...
			<div class="filling-form" id="home">
				<div class="filling-info-wrapper">
					<div class="row">
						...
						<div class=" col-md-6 bt-box text-end">
							<span class="top-arrow"><i @click.prevent="scrollToElement" class="fa-solid fa-arrow-up"></i></span>						
					</div>
					</div>					
				</div>
				<hr>
				<div class="filling-form-que">
					<ol>
										...
										<div class="row">
											...
											<div class="col-md-8">
												<select class="form-select" v-model="formData.Jurisdiction_tax_id"
													...
													<option disabled>Choose...</option>
													<option v-for="option in jurisdictionCountry" :key="option.value" :value="option.value">{{ option.label }}</option>
												</select>
						...
						<li>
							<div class="row">
								...
								<div class="col-xl-7 col-md-6 col-sm-8 select-rdo">
									<input type="checkbox" name="fincen" v-model="formData.FinCEN_Identifier" value="true">
							...
							<div class="row">
								...
								<div class="col-md-7">
									<select class="form-select" v-model="formData.Territory" id="Territory">
										<option disabled>Choose...</option>
										<option v-for="option in uscountry" :key="option.value" :value="option.value">{{ option.label }}</option>
									</select>
						...
						<li>
							<div class="row">
								...
								<div class="col-md-7 select-rdo">
									<input type="checkbox" name="exit_report" v-model="formData.Exit_reporting_company"
										value="true">
						...
						<div class="container" v-for="(formData, a) in applicant" :key="a">
						...
						<!-- <div class=" col-md-2 bt-box text-end">
								...
								<div class="row">
									...
									<div class="col-md-7 d-flex">
										<div class="current-radio-btn">
											...
											<input class="radio-start mx-2" type="radio" name="business" :value="true"
								...
								<div class="row">
									...
									<div class="col-md-7">
										<select class="form-select" v-model="formData.Identififying_document"
											...
											<option disabled>Choose...</option>
											<option v-for="option in document" :key="option.value" :value="option.value">{{ option.label }}</option>
										</select>
							...
							<li>
								...
								<ol type="a" style="margin-left: 0px!important;margin-top: 15px!important" >
									<li>
										<div class="row">
											<div class="col-md-4">
											...
											<div class="col-md-7">
												<select class="form-select" v-model="formData.Country_jurisdiction" id="Country">
											<option disabled>Choose...</option>
											<option v-for="option in jurisdictionCountry" :key="option.value" :value="option.value">{{ option.label }}</option>
										</select>												
									...
									<li>
										<div class="row">
											...
											<div class="col-md-7">
												<select class="form-select" v-model="formData.local" id="formData.Beneficial_Local">
													<option disabled>Choose...</option>
													<option v-for="option in tribes" :key="option.value" :value="option.value">{{ option.label }}</option>
												</select>
								...
								<div class="row">
									...
									<div class="col-md-7">
										...
										<button type="button" class="file btn btn-primary mx-1"
											@click="removeAttachmentapplicant">Remove Attachment</button>
						...
						<div class="container" v-for="(formData, b) in beneficial" :key="b">
							...
							<li>
								<div class="row">
									...
									<div class="col-md-7">
										...
										<button type="button" class="file btn btn-primary mx-1"
											@click="removeAttachment">Remove Attachment</button>
	...
	methods: {
		...
		validateForm() {
			...
			if (!this.formData.Exit_reporting_company) {
				this.formErrors.Exit_reporting_company = 'Exit reporting company is required';
				isValid = false;
			}
...
alert(this.formData.FinCEN_ID);
			...
			if (!this.formData.Beneficial_fincenID) {
				this.formErrors.Beneficial_fincenID = 'Beneficial Fincen id is required';
				isValid = false;
			}else{
